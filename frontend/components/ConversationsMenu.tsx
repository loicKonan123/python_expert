...
export function ConversationsMenu({
  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      {open && (
        <div
          className="absolute right-0 mt-2 w-[min(360px,calc(100vw-2rem))] max-h-[70vh] overflow-hidden flex flex-col rounded-2xl glass-card-strong shell-deep shadow-2xl"
          role="menu"
        >
          {/* Header */}
